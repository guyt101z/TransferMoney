              ...
              <div class="modal-body">
                	<form enctype="multipart/form-data">
                          ...
                          <div class="form-group">
                            	<label><?php echo $langCurrencyName;?> : </label>
                                ...
                                <table class="table table-striped table-bordered table-hover sortable" id="dataTables-example">
                                    ...
                                    <thead>
                                        <tr>
                                            ...
                                            <th><?php echo $langCurrencyName;?> </th>
                                    ...
                                    <tbody>
                                        ...
                                        <?php
											$select=$db->query("CALL spSearchCurrency('".$txtSearch."');");
											...
											if($rowselect>0){
												...
												echo'<tr class="even">
														...
														<td>'.$Description.'</td>
														<td class="center" >';
														echo "<a onclick=\"myOtherCost('".$CurrencyNo."','".$Name."','".$Description."')\">Update";
														echo '</a>
														</td>
													</tr>';
               ...
               <div class="modal fade" id="Order" tabindex="0" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                  ...
                  <div class="modal-content">
                      <div class="modal-header">
                        ...
                        <h4 class="modal-title" id="exampleModalLabel">New Currency</h4>
